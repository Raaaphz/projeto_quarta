...
export const vendaPorVendedor = async (req, res) => {
...
export const vendaCarro = async (req, res) => {
  ...
  try {
    ...
    // Inserir venda
    const vendaQuery = 'INSERT INTO vendas (valor, diavenda, cpf, placa, vendedor) VALUES (?, ?, ?, ?, ?)';
...
export const deletarVendas = async (req, res) => {
